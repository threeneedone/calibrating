...
if __name__ == "__main__":
    ...
    board = Chessboard(checkboard=(8, 5), size_mm=5)

    caml = Cam(glob(f"C:/Users/scienkong_robot/Desktop/calib/bi/20231016111/L_*.jpg"), board)

    camr = Cam(glob(f"C:/Users/scienkong_robot/Desktop/calib/bi/20231016111/R_*.jpg"), board)
