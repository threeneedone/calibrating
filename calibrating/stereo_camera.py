...
class Stereo:
    ...
    def disparity_to_depth(self, disparity):
        ...
        cv2.imwrite('C:/Users/scienkong_robot/Desktop/calib/1/disparity.jpg', disparity)
        depth = 1.0 * self.baseline * fx / disparity
        depth[depth > self.get_max_depth()] = 0
        depth[depth < 0] = 0

        cv2.imwrite('C:/Users/scienkong_robot/Desktop/calib/1/depth.jpg', depth)
        return depth
