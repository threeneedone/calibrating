...
if __name__ == "__main__":
    ...
    if not random_test_case:
        ...
        result = estereo.rectify(img1, img2)
        estereo.shows(*result)
    ...
    result = stereo13.rectify(img1, img3)
    stereo13.shows(*result)

    result = stereo13_re.rectify(img1, img3)
    stereo13_re.shows(*result)
